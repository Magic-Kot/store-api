...
const file_store_proto_rawDesc = "" +
	...
	"\x04Auth\x12;\n" +
	"\bRegister\x12\x16.store.RegisterRequest\x1a\x17.store.RegisterResponse\x122\n" +
	"\x05Login\x12\x13.store.LoginRequest\x1a\x14.store.LoginResponseB\x12Z\x10store.v1;storev1b\x06proto3"
...
var file_store_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: store.RegisterRequest
	(*RegisterResponse)(nil), // 1: store.RegisterResponse
	(*LoginRequest)(nil),     // 2: store.LoginRequest
	(*LoginResponse)(nil),    // 3: store.LoginResponse
}
var file_store_proto_depIdxs = []int32{
	0, // 0: store.Auth.Register:input_type -> store.RegisterRequest
	2, // 1: store.Auth.Login:input_type -> store.LoginRequest
	1, // 2: store.Auth.Register:output_type -> store.RegisterResponse
	3, // 3: store.Auth.Login:output_type -> store.LoginResponse
